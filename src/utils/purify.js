 ...
 *
 * Modified version of purify.js
 * Original work: DOMPurify (https://github.com/cure53/DOMPurify)
 * Copyright 2024 Dr.-Ing. Mario Heiderich, Cure53
 */

/* eslint-disable */

// TODO: Review and remove any unnecessary parts of this code for application-specific requirements
    ...
    const _checkValidNamespace = function _checkValidNamespace(element) {
        ...
        if (element.namespaceURI === SVG_NAMESPACE) {
            ...
            if (parent.namespaceURI === MATHML_NAMESPACE) {
                return (
                    tagName === "svg" &&
                    (parentTagName === "annotation-xml" || MATHML_TEXT_INTEGRATION_POINTS[parentTagName])
                );
            }
